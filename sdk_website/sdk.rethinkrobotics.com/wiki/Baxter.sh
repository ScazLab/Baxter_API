...
<link rel="canonical" href="RSDK_Shell"/>
...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-RSDK_Shell rootpage-RSDK_Shell skin-cavendishmw-rethinkrobotics action-view"><div id="container"><!-- start fragment header -->
	...
	<div id="accountActions"><a href="http://sdk-accounts.rethinkrobotics.com/public/NewUser">Create account</a><a href="a/index.php?title=Special:UserLogin&amp;returnto=RSDK+Shell">Log in</a></div>
        <!-- Search box -->
...
<div id="firstHeadingDiv" class="firstHeading">
    <h1 lang="en"><span dir="auto">RSDK Shell</span></h1>
        ...
        <ul><li><a href="Baxter.sh#">More</a><ul><li id="ca-viewsource"><a href="a/index.php?title=RSDK_Shell&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li><li id="ca-history"><a href="a/index.php?title=RSDK_Shell&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li></ul></li><li id="ca-nstab-main" class="selected"><a href="RSDK_Shell" title="View the content page [c]" accesskey="c">Page</a></li></ul>
...
<div id="mainContent"> <!-- cavendishmw: s/column-content/mainContent/ -->
  ...
  <div id="bodyContent" class="mw-body">
    ...
    <div id="contentSub"><span class="mw-redirectedfrom">(Redirected from <a href="a/index.php?title=Baxter.sh&amp;redirect=no" class="mw-redirect" title="Baxter.sh">Baxter.sh</a>)</span></div>
    <div id="jump-to-nav" class="mw-jump">Jump to: <a href="Baxter.sh#column-one">navigation</a>, <a href="Baxter.sh#searchInput">search</a></div>
    
  <!-- start content -->
  <div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><div class="mw-parser-output"><p>To communicate with and command Baxter, we must establish the connection between your development PC and the robot. Assuming proper <a href="Networking" title="Networking"> network setup</a>, the RSDK shell refers to the a configuration of your <a rel="nofollow" class="external text" href="http://wiki.ros.org/ROS/EnvironmentVariables">ROS environment</a> which points your PC to the <a rel="nofollow" class="external text" href="http://wiki.ros.org/Master">ROS Master</a>, while registering your IP or Hostname allowing other processes to find you.
</p><p><br />
The SDK provides a convenient script, <code> baxter.sh </code>, which helps foster the quickest and easiest ROS environment setup to get communicating with Baxter. This script should have been installed/configured during <a href="Workstation_Setup" title="Workstation Setup"> Getting Started - Workstation Setup Tutorial</a>, and the <a href="Hello_Baxter" title="Hello Baxter"> Getting Started - Hello Baxter! Tutorial</a>.
</p>
<div id="toc" class="toc"><div class="toctitle" lang="en" dir="ltr"><h2>Contents</h2></div>
<ul>
<li class="toclevel-1 tocsection-1"><a href="Baxter.sh#Quick_Environment_Setup_Via_Baxter.sh"><span class="tocnumber">1</span> <span class="toctext">Quick Environment Setup Via Baxter.sh</span></a></li>
<li class="toclevel-1 tocsection-2"><a href="Baxter.sh#Detailed_Description.2FSetup"><span class="tocnumber">2</span> <span class="toctext">Detailed Description/Setup</span></a></li>
<li class="toclevel-1 tocsection-3"><a href="Baxter.sh#Verify_RSDK_Shell"><span class="tocnumber">3</span> <span class="toctext">Verify RSDK Shell</span></a>
<ul>
<li class="toclevel-2 tocsection-4"><a href="Baxter.sh#Test_ability_to_ping_robot."><span class="tocnumber">3.1</span> <span class="toctext">Test ability to ping robot.</span></a></li>
<li class="toclevel-2 tocsection-5"><a href="Baxter.sh#Test_ability_to_command_the_robot"><span class="tocnumber">3.2</span> <span class="toctext">Test ability to command the robot</span></a>
<ul>
<li class="toclevel-3 tocsection-6"><a href="Baxter.sh#Timeout_observed_when_trying_to_enable_the_robot."><span class="tocnumber">3.2.1</span> <span class="toctext">Timeout observed when trying to enable the robot.</span></a></li>
</ul>
</li>
</ul>
</li>
...
<form id="tabs-inputform" class="tabs tabs-inputform" action="Baxter.sh#"></form><div class="tabs tabs-tabbox"><input type="radio" form="tabs-inputform" id="tabs-input-1-0" name="tabs-1" class="tabs-input tabs-input-0" checked="" /><input type="radio" form="tabs-inputform" id="tabs-input-1-1" name="tabs-1" class="tabs-input tabs-input-1" /><label class="tabs-label" for="tabs-input-1-1" data-tabpos="1">Baxter.sh ROS Environment Setup</label><wbr /><input type="radio" form="tabs-inputform" id="tabs-input-1-2" name="tabs-1" class="tabs-input tabs-input-2" /><label class="tabs-label" for="tabs-input-1-2" data-tabpos="2">Standard bashrc ROS Environment Setup</label><wbr /><div class="tabs-container" style="">
...
</p><p><b>Important:</b> This hostname must be resolvable to Baxter. To test if your hostname is resolvable to Baxter, please visit the development PC <a href="Networking" title="Networking">Networking</a> page.
</p>
...
<p>Modifying where 'your_hostname' is the hostname of your PC.
</p><p><b>Important:</b> This hostname must be resolvable to Baxter. To test if your hostname is resolvable to Baxter, please visit the development PC <a href="http://sdk.rethinkrobotics.com/wiki/a/index.php?title=Hostname_Validation&amp;action=edit&amp;redlink=1" class="new" title="Hostname Validation (page does not exist)">Hostname Validation</a> page.
</p>
...
<p>If unable to ping the robot visit <a href="Connecting_and_Testing_the_Development_Workstation" title="Connecting and Testing the Development Workstation">this page</a>.
</p>
...
<!-- 
NewPP limit report
Cached time: 20190815153838
Cache expiry: 86400
Dynamic content: false
CPU time usage: 0.085 seconds
Real time usage: 6.424 seconds
...
<!-- Saved in parser cache with key wikisdk:pcache:idhash:374-0!canonical and timestamp 20190815153831 and revision id 4573
 -->
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="a/index.php?title=RSDK_Shell&amp;oldid=4573">http://sdk.rethinkrobotics.com/wiki/a/index.php?title=RSDK_Shell&amp;oldid=4573</a>"</div>
...
<!-- end fragment mainContent --></div> <!-- /mBody --><div class="visualClear"></div><!-- start fragment footer -->    <div id="footer" role="contentinfo">
    ...
    </div><!-- end fragment footer --></div><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgPageParseReport":{"limitreport":{"cputime":"0.085","walltime":"6.424","ppvisitednodes":{"value":279,"limit":1000000},"ppgeneratednodes":{"value":654,"limit":1000000},"postexpandincludesize":{"value":0,"limit":2097152},"templateargumentsize":{"value":0,"limit":2097152},"expansiondepth":{"value":4,"limit":40},"expensivefunctioncount":{"value":0,"limit":100},"unstrip-depth":{"value":2,"limit":20},"unstrip-size":{"value":15396,"limit":5000000},"timingprofile":["100.00%    0.000      1 -total"]},"cachereport":{"timestamp":"20190815153838","ttl":86400,"transientcontent":false}}});});</script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":54});});</script></body></html>